...
Deno.serve(async (request: Request) => {
  ...
  try {
    ...
    const skillId = requireIdentifier(body.skill_id, "skill_id");
    if (isResponse(skillId)) return skillId;
    ...
    console.error("Unexpected purchase-skill failure", error);
